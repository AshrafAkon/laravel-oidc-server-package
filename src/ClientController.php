...
use AALP\Passport\Bridge\ClientRepository;
...
class ClientController extends LaravelClientController
{
     ...
     *
     * @var \AALP\Passport\Bridge\ClientRepository
     */
    protected $clients;
     ...
     *
     * @param  \AALP\Passport\ClientRepository  $clients
     ...
     * @return \Illuminate\Http\Response|\AALP\Passport\Client
     */
