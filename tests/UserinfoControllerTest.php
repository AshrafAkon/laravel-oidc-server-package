...
use AALP\Passport\Passport;
use AALP\Passport\PassportServiceProvider;
...
class UserinfoControllerTest extends PassportTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $accessTokenRepository = m::mock(\AALP\Passport\Bridge\AccessTokenRepository::class);
        ...
        $this->app->instance(
            \AALP\Passport\Bridge\AccessTokenRepository::class,
